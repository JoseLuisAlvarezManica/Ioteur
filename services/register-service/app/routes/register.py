...
from ..schemas import RegisterRecordResponse
...
@register_router.get(
    "/{device_id}",
    response_model=list[RegisterRecordResponse],
    summary="Get all registers for a device",
)
...
@register_router.get(
    "/{device_id}/by-date",
    response_model=list[RegisterRecordResponse],
    summary="Get registers for a device filtered by date range",
)
